...
- (void)viewDidLoad {
    ...
    NSString *performanceScript = @"(function(){"
      ...
      "var sxOpen=XMLHttpRequest.prototype.open,sxSend=XMLHttpRequest.prototype.send;"
      "XMLHttpRequest.prototype.open=function(method,url){this.__sxRequest={method:String(method||''),identity:safeRequestIdentity(url)};return sxOpen.apply(this,arguments);};"
