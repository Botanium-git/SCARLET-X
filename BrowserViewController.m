...
- (void)viewDidLoad {
    ...
    NSString *performanceScript = @"(function(){"
      ...
      "function tryMenuWarmup(){if(menuWarmupDone||!postSent)return;var btn=document.querySelector(\'[data-testid=AppTabBar_Profile_Link]\')||document.querySelector(\'[data-testid=SideNav_AccountSwitcher_Button]\')||document.querySelector(\'[data-testid=AppTabBar_Account_Menu]\');if(!btn){setTimeout(tryMenuWarmup,250);return;}menuWarmupDone=true;send(\'menu-warmup-start\',{testid:btn.getAttribute(\'data-testid\')||\'\'});btn.click();setTimeout(function(){document.body.click();send(\'menu-warmup-complete\',{method:\'body-click\'});},700);}"
