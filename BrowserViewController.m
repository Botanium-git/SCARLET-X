...
- (void)viewDidLoad {
    ...
    NSString *performanceScript = @"(function(){"
      ...
      "function scheduleModalSnapshot(){clearTimeout(modalDiagTimer);modalDiagTimer=setTimeout(function(){modalSnapshot('mutation');},25);}"
