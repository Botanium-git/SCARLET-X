...
- (void)viewDidLoad {
    ...
    NSString *performanceScript = @"(function(){"
      ...
      "sxPositionPullRefreshIndicator(document);new MutationObserver(function(rs){rs.forEach(function(r){Array.from(r.addedNodes||[]).forEach(function(n){if(n&&n.nodeType===1)sxPositionPullRefreshIndicator(n);});});}).observe(document.documentElement,{childList:true,subtree:true});"
